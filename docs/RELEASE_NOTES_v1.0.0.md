# Release Notes — v1.0.0 (first stable)
...
v1.0.0 marks the first stable release. It bundles ~6 months of
feature work + a multi-round hardening sweep into a single, audited,
freeze-ready package.
...
| Unit + integration suite | 534/534 passing |
...
Three EXEs uploaded to the v1.0.0 release page:

| Asset | Size | Best for |
|---|---|---|
| `WhisperProject-v1.0.0-Portable.exe` | ~450 MB | one file, no install |
| `WhisperProject-v1.0.0-Setup-Compact.exe` | ~330 MB | normal user — Start-menu shortcut |
| `WhisperProject-v1.0.0-Setup-Standard.exe` | ~350 MB | inspectable — files live on disk |
