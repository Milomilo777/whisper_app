...
How to produce Windows binaries from source. v1.0.0 ships three
...
:: Output: dist_installer\WhisperProject-v1.0.0-Setup-Standard.exe
```
...
Output: `dist\WhisperProject-v1.0.0-Portable.exe` (~447 MB; the bundled
...
```cmd
:: Method A
set WHISPER_SMOKE_EXE=dist\WhisperProject-v1.0.0-Portable.exe
